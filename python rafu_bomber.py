...
def update():
    ...
    os.system("cd .. && rm -rf Rafu && git clone https://github.com/Rafu0878/rafu_bot.git > /dev/null 2>&1")
    
    psb("\n\033[92m    [\033[37m*\033[92m] Update Complete!")
    psb("\033[92m    [\033[37m*\033[92m] Starting Tool...")
    time.sleep(0.8)
    
    os.system("cd .. && cd rafu_bot && python rafu_bomb.py")
...
def logo():
    ...
    print("│ \033[95mGitHub : https://github.com/Rafu0878/rafu_bot.git \033[94m│".center(columns+9))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        time.sleep(0.6)
        print("\033[92m[\033[93m★\033[92m] Thanks For Using My Tool \033[92m[\033[93m★\033[92m]".center(columns + 30))
        print("\033[37m")
